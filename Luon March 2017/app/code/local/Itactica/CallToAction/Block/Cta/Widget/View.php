...
class Itactica_CallToAction_Block_Cta_Widget_View extends Mage_Catalog_Block_Product_Abstract implements Mage_Widget_Block_Interface
{
    ...
    {
        $identifier = $this->getData('cta_id');
        $cacheArray = array(
     ...
     * @var string
     */
    protected $_htmlTemplate = 'itactica_calltoaction/view.phtml';
    ...
    public function getDataAttr() {
        ...
        if ($cta->getButtonType() != 'none') {
            ...
            $_attr .= ' data-borderover="' . $cta->getButtonBorderColorHover() . '"';
            $_attr .= ' data-borderout="' . $cta->getButtonBorderColor() . '"';
