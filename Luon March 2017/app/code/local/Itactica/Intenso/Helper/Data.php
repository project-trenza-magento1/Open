...
class Itactica_Intenso_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function showWishlistInRecentlyViewed() {
		...
		/**
		 * returns true if "Display Qty field as Dropdown" is enabled
		 * @access public
		 * @return bool
		 */
		public function qtyFieldIsDropdown() {
			return Mage::getStoreConfig('intenso/product_page/qty_field_is_dropdown', Mage::app()->getStore());
		}
