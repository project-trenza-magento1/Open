 ...
 */ 
class CommerceThemes_GuestToReg_Model_Rewrite_PaypalExpressCheckout extends Mage_Paypal_Model_Express_Checkout
{
    ...
    {
		#Mage::log("Saved Order in PaypalExpresscheckout");
		try {
        	$order = parent::placeOrder($token, $shippingMethodCode = null);
