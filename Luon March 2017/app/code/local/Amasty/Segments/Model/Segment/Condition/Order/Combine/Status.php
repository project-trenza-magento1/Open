...
class Amasty_Segments_Model_Segment_Condition_Order_Combine_Status
    extends Amasty_Segments_Model_Condition_Abstract
{
    ...
    {
        parent::__construct();
        $this->setType('amsegments/segment_condition_order_combine_status');
        $this->setValue(null);
    }
    ...
    public function index($websiteIds, $combineCondition)
    {
        ...
        $select->where("salesOrder.status " . $operator . " ? ", $value);
