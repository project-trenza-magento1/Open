...
class Amasty_Segments_Model_Segment_Condition_Order_Address_Shipping_City
    extends Amasty_Segments_Model_Condition_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('amsegments/segment_condition_order_address_shipping_city');
        $this->setValue(null);
    }
    ...
    protected function _getResultExpr()
    {
        ...
        $sql = $this->getResource()->getReadConnection()->quoteInto("salesOrderAddress.city {$operator} ?", $value);
