...
class Amasty_Segments_Model_Segment_Condition_Order_Address_Billing_Email
    extends Amasty_Segments_Model_Condition_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('amsegments/segment_condition_order_address_billing_email');
        $this->setValue(null);
    }
    ...
    protected function _getResultExpr()
    {
        ...
        $sql = $this->getResource()->getReadConnection()->quoteInto("salesOrderAddress.email {$operator} ?", $value);
