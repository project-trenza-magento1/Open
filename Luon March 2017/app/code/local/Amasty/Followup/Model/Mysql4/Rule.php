 ...
 */ 
class Amasty_Followup_Model_Mysql4_Rule extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amfollowup/rule', 'rule_id');
    }
    ...
    public function getAttributes()
    {
        ...
        $tbl   = $this->getTable('amfollowup/attribute');
