...
class Amasty_Followup_Model_Rule extends Mage_Rule_Model_Rule
{
    ...
    function getStartEvent(){
        ...
        switch ($this->getStartEventType()){
            ...
            break;
            case self::TYPE_CUSTOMER_WISHLIST_SALE:
                $ret = new Amasty_Followup_Model_Event_Customer_Wishlist_Sale($this);
            break;
            case self::TYPE_CUSTOMER_WISHLIST_BACK_INSTOCK:
                $ret = new Amasty_Followup_Model_Event_Customer_Wishlist_Instock($this);
            break;
            default:
    ...
    function getCancelEvents(){
        ...
        if ($this->isOrderRelated()){
            foreach(Mage::getResourceModel('sales/order_status_collection') as $status){
