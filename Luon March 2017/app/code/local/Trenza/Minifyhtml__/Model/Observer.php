...
class Trenza_Minifyhtml_Model_Observer
{
    ...
    public function alterOutput($observer)
    {
		...
		//Mage::log('Trenza_Minifyhtml_Model_Observer::observer '. time());
		...
		{	
			...
			// minify
			$html=Trenza_Minifyhtml_Model_Minify::minify($html,array('jsCleanComments' => true));
