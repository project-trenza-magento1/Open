...
class Avenla_KlarnaCheckout_Block_KCO_Confirmation extends Mage_Core_Block_Template
{
	...
	/**
     * Return Facebook Purchase event track
     * @return [type]
     * @author edudeleon
     * @date   2017-06-05
     */
    public function getFacebookPurchaseEvent($orderId){
        ...
        if(Mage::helper('remmote_facebookpixelremarketing')->purchaseEnabled()){
            ...
            // if($pixelEvent){
                ...
                return "<script>fbq('track', 'Purchase', {
