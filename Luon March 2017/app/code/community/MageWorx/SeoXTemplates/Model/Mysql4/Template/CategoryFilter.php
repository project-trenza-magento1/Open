 ...
 */
class MageWorx_SeoXTemplates_Model_Mysql4_Template_CategoryFilter extends MageWorx_SeoXTemplates_Model_Mysql4_Template
{
    /**
     * Define main table
     *
    ...
    {
        $this->_init('mageworx_seoxtemplates/template_categoryFilter', 'template_id');
    }
    ...
    {
        return Mage::getResourceSingleton("mageworx_seoxtemplates/template_relation_categoryFilter");
    }
