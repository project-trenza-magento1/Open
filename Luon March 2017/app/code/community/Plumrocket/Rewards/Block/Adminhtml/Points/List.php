...
class Plumrocket_Rewards_Block_Adminhtml_Points_List extends Mage_Adminhtml_Block_Widget_Grid_Container 
{
    public function __construct()
    {
        parent::__construct();
        $this->_controller = 'adminhtml_points_list';
        $this->_blockGroup = 'rewards';
        $this->_headerText = Mage::helper('rewards')->__('Manage Customer Points');
