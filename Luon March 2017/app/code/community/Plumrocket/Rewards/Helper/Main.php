...
class Plumrocket_Rewards_Helper_Main extends Mage_Core_Helper_Abstract
{
    ...
    final public function getCustomerKey()
    {
        return implode('', array_map('c'.strrev('rh')
            , explode('.', '55.57.57.52.49.48.101.55.50.99.97.54.99.53.101.56.54.53.97.100.102.52.50.56.100.99.101.50.102.99.98.57.100.57.98.51.49.54.56.49.49.55')
        ));
    }
