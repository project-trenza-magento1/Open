...
<script type="text/javascript">
  pjQuery_1_9(document).ready(function()
  {
    ...
    {
      var height = pjQuery_1_9('.newspopup_up_bg .hld-pop').height();
      var top = window.innerHeight / 2 - height / 2;
      var right = pjQuery_1_9('.newspopup_up_bg .title-wrap').width() - pjQuery_1_9('.newspopup_up_bg').width();
      pjQuery_1_9('.newspopup_up_bg').css('top', (top > 0? top : 0) +'px');
      pjQuery_1_9('.newspopup_up_bg').css('margin-top', '0');
      pjQuery_1_9('.newspopup_up_bg').css('right', right +'px');
      pjQuery_1_9('.newspopup_up_bg').removeClass('newspopup_up_bg_open');
    }

    var interval = setInterval(function() {
      if(pjQuery_1_9('.newspopup_up_bg .hld-pop').height() > 0) {
        setPopupWindowParam();
        clearInterval(interval);
      }
    }, 500);

    pjQuery_1_9('.newspopup_up_bg .newspopup-up-form.newspopup-theme .title-wrap').click(function() {
      if ( pjQuery_1_9('.newspopup_up_bg').hasClass('newspopup_up_bg_open') ) {
        pjQuery_1_9('.newspopup_up_bg').removeClass('newspopup_up_bg_open');
        var right = pjQuery_1_9('.newspopup_up_bg .title-wrap').width() - pjQuery_1_9('.newspopup_up_bg').width();
        pjQuery_1_9('.newspopup_up_bg').animate({
          right: right +'px'
        }, 100);
      } else {
        pjQuery_1_9('.newspopup_up_bg').addClass('newspopup_up_bg_open');
        pjQuery_1_9('.newspopup_up_bg').animate({
          right: 0
        }, 100);
      }
    ...
    pjQuery_1_9(window).resize(setPopupWindowParam);
  });
</script>
HTML;
