...
class Plumrocket_Newsletterpopup_Block_Adminhtml_Popups_Edit_Tabs_Template
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('general_fieldset', array('legend' => Mage::helper('newsletterpopup')->__('Theme Template')));
    ...
    {
        return Mage::helper('newsletterpopup')->__('Theme Template');
    }
