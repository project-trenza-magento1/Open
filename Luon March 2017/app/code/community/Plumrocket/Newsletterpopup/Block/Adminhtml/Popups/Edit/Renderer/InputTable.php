...
class Plumrocket_Newsletterpopup_Block_Adminhtml_Popups_Edit_Renderer_InputTable
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('newsletterpopup/adminhtml_popups_edit_renderer_inputTable_column')
                ->setData($column)
                ->setGrid($this);
        } else {
