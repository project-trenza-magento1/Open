...
class Plumrocket_Newsletterpopup_Block_System_Config_FieldsTag_InputTable
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('newsletterpopup/system_config_fieldsTag_inputTable_column')
                ->setData($column)
                ->setGrid($this);
        } else {
